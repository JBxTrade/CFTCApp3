...
export class UnSubComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-un-sub div table .btn-danger'));
  title = element.all(by.css('jhi-un-sub div h2#page-heading span')).first();
...
export class UnSubUpdatePage {
  pageTitle = element(by.id('jhi-un-sub-heading'));
...
export class UnSubDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-unSub-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-unSub'));
